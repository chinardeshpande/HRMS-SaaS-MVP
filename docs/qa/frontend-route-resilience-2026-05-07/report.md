...
Run ID: ROUTE-2026-05-07-1778144821808
...
| HR_DASHBOARD | HR dashboard route renders after session restore | hr | passed | 200, chars=2429, docs/qa/frontend-route-resilience-2026-05-07/screenshots/hr_dashboard-hr.png |  |
...
| EMPLOYEE_NAV | Employee navigation excludes restricted Settings workflow | employee | passed | 200, chars=2268, docs/qa/frontend-route-resilience-2026-05-07/screenshots/employee_nav-employee.png |  |
