...
Run date: 2026-05-05
Run id: ALV-2026-05-05-1777961049976
Application: https://aurorahr.in
API: https://aurorahr.in/api/v1

## Executive summary

Executed 29 checks: 28 passed, 1 failed.
...
| LEAVE_DATA_01 | Employee applies casual leave for manager approval | employee | PASS | leaveId=3723231a-036b-413e-8076-648007f0a877 |  |
| LEAVE_DATA_02 | Employee applies sick leave for rejection path | employee | PASS | leaveId=33383ca9-639e-4514-8ce6-cda382e5fdc1 |  |
| LEAVE_APPROVAL_01 | Manager approves one pending leave request | manager | PASS | approved leaveId=3723231a-036b-413e-8076-648007f0a877 |  |
| LEAVE_APPROVAL_02 | HR rejects one pending leave request | hr | PASS | rejected leaveId=33383ca9-639e-4514-8ce6-cda382e5fdc1 |  |
| ATT_REG_01 | Employee creates attendance regularization request | employee | PASS | editId=444a0bad-fef0-47af-8867-757e5ee74012 |  |
| ATT_REG_02 | Manager approves one attendance regularization | manager | PASS | approved editId=444a0bad-fef0-47af-8867-757e5ee74012 |  |
| ATT_REG_03 | Employee creates second attendance regularization request | employee | PASS | editId=19390238-01aa-450f-9ceb-74426e62b6f5 |  |
| ATT_REG_04 | HR rejects one attendance regularization | hr | PASS | rejected editId=19390238-01aa-450f-9ceb-74426e62b6f5 |  |
...
| REPORT_DATA_01 | HR retrieves attendance and leave reporting APIs | hr | FAIL | runtime/API error | GET /attendance/by-department?startDate=2026-05-05&endDate=2026-05-05 failed: column department.departmentname does not exist |
...
| VIS_ATT_HR_03 | HR attendance device/file sync modal | hr | PASS | screenshots/10-hr-attendance-sync-modal.png | Current UI uses mock preview/save behavior. |
...
- The live production `/attendance/by-department` report failed because it referenced a non-existent department column. This branch fixes the query to use `Department.name` while preserving the `departmentName` API alias.
